...
const postsData = [
  ...
  {
    slug: "evolucao-ia-ultimos-2-anos",
    title: "Como a Inteligência Artificial Evoluiu nos Últimos 2 Anos: Análise Completa",
    description:
      "Análise profunda da evolução da IA de 2023-2025: modelos, aplicações, impacto no mercado e o que mudou para sempre. Dados, cases e previsões confiáveis.",
    category: "IA",
    tags: ["IA", "Evolução", "Tecnologia", "Tendências", "2025"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "12 min",
  ...
  {
    slug: "ia-arquitetura-revolucao-setor",
    title: "IA na Arquitetura: Como a Inteligência Artificial Está Revolucionando o Setor",
    description:
      "Descubra como IA transforma arquitetura: design generativo, renders fotorrealísticos, otimização de projetos. Cases reais, ferramentas e futuro do setor.",
    category: "Casos de Uso",
    tags: ["IA", "Arquitetura", "Design", "Automação", "Tecnologia"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "14 min",
  ...
  {
    slug: "ia-substituir-pessoas-verdade",
    title: "IA Vai Substituir Pessoas? A Verdade Sobre o Futuro do Trabalho com Dados Reais",
    description:
      "Análise baseada em dados: IA vai substituir ou transformar empregos? Descubra a verdade sobre automação, profissões em risco e oportunidades reais em 2025.",
    category: "IA",
    tags: ["IA", "Emprego", "Futuro", "Automação", "Mercado de Trabalho"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "15 min",
  ...
  {
    slug: "profissoes-que-mais-usaram-ia-2025",
    title: "10 Profissões Que Mais Utilizaram IA em 2025: Ranking Completo",
    description:
      "Descubra quais profissões lideram a adoção de IA em 2025. Rankings, salários, cases reais e como você pode se destacar usando Inteligência Artificial.",
    category: "IA",
    tags: ["IA", "Profissões", "Mercado de Trabalho", "2025", "Tendências"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "13 min",
  ...
  {
    slug: "prospeccao-ia-2026",
    title: "Prospecção da IA para 2026: 7 Tendências Que Vão Dominar o Mercado",
    description:
      "Descubra as 7 tendências de IA para 2026 baseadas em dados. Veja o que especialistas preveem e como se preparar agora para o futuro que já começou.",
    category: "IA",
    tags: ["IA", "Tendências", "2026", "Futuro", "Inovação"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "16 min",
  ...
  {
    slug: "ia-fabrica-milionarios-futuro",
    title: "IA é uma Fábrica de Milionários do Futuro? A Verdade Sobre Oportunidades Reais",
    description:
      "Descubra a verdade sobre enriquecer com IA: oportunidades reais, expectativas realistas, casos de sucesso comprovados e como capturar valor sem cair em promessas vazias.",
    category: "Casos de Uso",
    tags: ["IA", "Empreendedorismo", "Oportunidades", "Negócios", "Startup"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "17 min",
  ...
  {
    slug: "maiores-tendencias-ia-2026",
    title: "8 Maiores Tendências de IA para 2026: O Que Vai Dominar o Mercado",
    description:
      "Descubra as 8 tendências de IA que dominarão 2026. Análise baseada em dados, insights de especialistas e como se posicionar agora para capturar valor.",
    category: "IA",
    tags: ["IA", "Tendências", "2026", "Futuro", "Inovação", "Previsões"],
    author: "Equipe Meu Agente",
    date: "2025-12-09",
    coverImage: "/placeholder.svg",
    readTime: "19 min",
